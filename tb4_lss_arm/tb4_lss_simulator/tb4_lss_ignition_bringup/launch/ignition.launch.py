...
def generate_launch_description():
    ...
    # pkg_tb4_lss_ignition_gui_plugins = get_package_share_directory(
    #     'tb4_lss_ignition_gui_plugins')
    pkg_tb4_lss_description = get_package_share_directory(
        'lss_arm_description')
    # pkg_tb4_lss_navigation = get_package_share_directory(
    #     'tb4_lss_navigation')
    pkg_tb4_lss_viz = get_package_share_directory(
        'lss_arm_viz')
    ...
    ign_gui_plugin_path = SetEnvironmentVariable(
        ...
        value=[
            # os.path.join(pkg_tb4_lss_ignition_gui_plugins, 'lib'), ':' +
    ...
    tb4_lss_ros_ign_bridge_launch = PathJoinSubstitution(
        [pkg_tb4_lss_ignition_bringup, 'launch', 'ros_ign_bridge.launch.py'])
    rviz_launch = PathJoinSubstitution(
        [pkg_tb4_lss_viz, 'launch', 'display_robot.launch.py'])
    ...
    # node_launch = PathJoinSubstitution(
    #     [pkg_tb4_lss_ignition_bringup, 'launch', 'tb4_lss_nodes.launch.py'])
    ...
    robot_description_launch = PathJoinSubstitution(
        [pkg_tb4_lss_description, 'launch', 'robot_description.launch.py'])
    ...
    # ROS Ign bridge
    tb4_lss_ros_ign_bridge = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([tb4_lss_ros_ign_bridge_launch]),
    ...
    ld.add_action(tb4_lss_ros_ign_bridge)
    ld.add_action(rviz2)
